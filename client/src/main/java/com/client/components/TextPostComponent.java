...
public class TextPostComponent extends StackPane {
    Post post;
    boolean isLiked;
    User viewer;
    ...
    public TextPostComponent(Post post) throws IOException {
        this.post = post;
        ...
        mainAnchorpane.setPrefSize(500.0, 200.0);
        mainAnchorpane.setPadding(new Insets(5.0));
        ...
        profileImageView.setFitHeight(37.0);
        profileImageView.setFitWidth(43.0);
        profileImageView.setLayoutX(14.0);
        profileImageView.setLayoutY(6.0);
        ...
        nameLabel.setLayoutY(17.0);
        nameLabel.setFont(new Font(16.0));

        likeButton = new Button();
        likeButton.setLayoutX(14.0);
        likeButton.setLayoutY(164.0);
        likeButton.setPrefSize(27.0, 26.0);
        ...
        likedByButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                ...
                backButton.setOnAction(new EventHandler<ActionEvent>() {
                    @Override
                    public void handle(ActionEvent actionEvent) {
                        TextPostComponent.super.getChildren().remove(1);
                ...
                TextPostComponent.super.getChildren().add(root);
                try {
        ...
        captionTextArea.setLayoutY(46.0);
        captionTextArea.setPrefSize(480.0, 118.0);
        captionTextArea.setPromptText("Caption");
        captionTextArea.setWrapText(true);

        mainAnchorpane.getChildren().addAll(likedByButton, profileImageView, usernameLabel, nameLabel, likeButton, commentButton, captionTextArea);
